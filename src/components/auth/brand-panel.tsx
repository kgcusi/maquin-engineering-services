...
export function BrandPanel() {
  return (
    <aside className="relative hidden flex-col justify-between overflow-hidden bg-[#303030] p-10 text-white lg:flex xl:p-14">
      <div
        aria-hidden
      ...
      <div className="relative z-10">
        <Brand variant="mark" theme="dark" className="h-8" />
      </div>

      {/* centered identity */}
      <div className="relative z-10 flex flex-col items-center text-center">
        <Brand variant="mark" theme="dark" priority className="mb-7 h-24" />
